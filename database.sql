...
COPY public."order" (order_id, user_id, active, courier_id, star_rating, total_price, "timestamp", address) FROM stdin;
AA1234567890	1	t	\N	\N	0.5	2019-12-13 17:26:46.080838	Rua do Padeiro, nº 221b
AA0987654321	1	f	1	4	11.98	2019-12-13 18:17:50.165724	Rua da Pêga, nº 1
\.
...
COPY public.order_item (order_item_id, quantity, cumul_price, discount, product_id, order_id, request) FROM stdin;
3	1	0.5	0.00	1	AA1234567890	\N
4	1	0	0.00	\N	AA1234567890	Seis croissants de chocolate
5	1000	11.98	0.00	2	AA0987654321	\N
\.
...
COPY public."user" (user_id, email, password, first_name, last_name, nif, photo, phone, address) FROM stdin;
2	rrosmaninho@gmail.com	978c48b4da5cf815c80a8ce91e5efc96d7429d36944a81fc7282be23a591b8b7	Rodrigo	Rosmaninho	987654321	\N	969696969	Rua de Luís Cipriano, nº10, 1º Esq.
1	euricodias@gmail.com	4612c7efb0fb01c10d44533775897e336ac797ba5d88ad210294b37bc567ab0c	Eurico	Dias	123456789	\N	919999999	Rua da Pêga, nº 1
\.
...
SELECT pg_catalog.setval('public.courier_courier_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.order_item_order_item_id_seq', 5, true);
